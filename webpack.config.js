...
module.exports = async (env, argv) => {
  ...
  if (argv.mode !== "production" || env.bundleAnalyzer) {
    ...
    if (env.localDev) {
      ...
      Object.assign(process.env, {
        HOST: "0.0.0.0",
        RETICULUM_SOCKET_SERVER: "0.0.0.0",
        CORS_PROXY_SERVER: "0.0.0.0:4000",
        NON_CORS_PROXY_DOMAINS: "hubs.local,dev.reticulum.io,0.0.0.0",
        BASE_ASSETS_PATH: "https://0.0.0.0:8080/",
        RETICULUM_SERVER: "0.0.0.0:4000",
        POSTGREST_SERVER: "",
        ITA_SERVER: "",
        UPLOADS_HOST: "https://0.0.0.0:4000"
      });
    }
  }
  ...
  const host = process.env.HOST_IP || env.localDev || env.remoteDev ? "0.0.0.0" : "localhost";
